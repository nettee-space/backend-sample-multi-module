...
public enum ReplyQueryErrorCode implements ErrorCode {
    ...
    ReplyQueryErrorCode(String message, HttpStatus httpStatus) {
    ...
    @Override
    public ReplyQueryException exception() {
        return new ReplyQueryException(this);
    }

    @Override
    public ReplyQueryException exception(Throwable cause) {
        return new ReplyQueryException(this, cause);
    }

    @Override
    public RuntimeException exception(Runnable runnable) {
        return new ReplyQueryException(this, runnable);
    }

    @Override
    public RuntimeException exception(Runnable runnable, Throwable cause) {
        return new ReplyQueryException(this, runnable, cause);
    }

    @Override
    public RuntimeException exception(Supplier<Map<String, Object>> payload) {
        return new ReplyQueryException(this, payload);
    }

    @Override
    public RuntimeException exception(Supplier<Map<String, Object>> payload, Throwable cause) {
        return new ReplyQueryException(this, payload, cause);
    }
}
