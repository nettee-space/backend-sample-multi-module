...
public class PostCommandDto {
    ...
    @Builder
    public record PostUpdateTotalViewsCommand(
            @NotBlank(message = "id를 입력하십시오.")
            Long id,
    ...
    @Builder
    public record PostUpdateTotalLikesCommand(
            @NotBlank(message = "id를 입력하십시오.")
            Long id,
    ...
    @Builder
    public record PostUpdateTotalSharesCommand(
            @NotBlank(message = "id를 입력하십시오.")
            Long id,
    ...
    @Builder
    public record PostCommandResponse(
            Post post
    ) {
